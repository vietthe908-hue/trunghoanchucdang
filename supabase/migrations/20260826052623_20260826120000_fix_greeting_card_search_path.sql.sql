/*
# Fix create_greeting_card search_path for pgcrypto

The function uses SET search_path = public, which excludes the schema where pgcrypto's gen_random_bytes lives.
Change to SET search_path = public, pgcrypto (or extensions schema) so gen_random_bytes resolves.
*/
